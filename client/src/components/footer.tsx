  ...
  const socialLinks = [
    {
      ...
      href: "https://instagram.com/yumia.ai"
    },
    {
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              ...
              Sua parceira estratégica para inovação e crescimento sustentável.
            </p>
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social, index) => (
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="w-10 h-10 p-0 bg-blue-600 border-blue-600 hover:bg-blue-700 hover:border-blue-700"
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2025 YumIA. Todos os direitos reservados.
          </p>
