  ...
  return (
    <main style={{ background: C.bg, color: C.text, fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <div className="hero-inner">
          <div>
            ...
            <h2 className="hero-h2" style={{ color: C.gold }}>
              A YumIA transforma consultas perdidas<br />em faturamento real.
            </h2>
            <p className="hero-body" style={{ color: C.muted }}>
              Consultas que chegam fora do horário e não são respondidas. Base de clientes inativos esquecida.
              Advogados fazendo triagem manual. Tudo isso é receita que poderia estar no caixa.
            </p>
          ...
          <div className="hero-stats-grid">
            {[
              { num: '5 min', label: 'Janela de ouro para converter um lead', sub: 'Depois disso, conversão cai 80%' },
              { num: '70%', label: 'Dos contatos que não viram clientes', sub: 'Problema de qualificação' },
              { num: 'R$ 500+', label: 'Valor médio da hora de advogado', sub: 'Gasta em triagem, não em faturar' },
      ...
      <section id="problema" className="section-padded" style={{ background: '#09091a' }}>
        <div className="container">
          <div className="section-header">
            <SectionTag>O que trava escritórios de advocacia</SectionTag>
            <h2 className="section-h2" style={{ color: C.white }}>
              Cliente que liga e não é atendido<br />é cliente que vai para o concorrente.
            </h2>
          </div>
          <div className="grid-2">
            {[
              { icon: '⏱️', title: 'Consulta perdida fora do horário', body: 'Lead que contacta às 22h ou no fim de semana não espera até segunda. Vai para quem responde primeiro.' },
              { icon: '📋', title: 'Triagem manual e cara', body: 'Advogado gastando hora valiosa em triagem que a IA faz em 60 segundos. Hora de advogado é cara demais para tela de filtro.' },
              { icon: '💤', title: 'Base antiga esquecida', body: 'Clientes que já confiaram no escritório e nunca foram reabordados. Oportunidades de novos casos e indicações dormindo na base.' },
              { icon: '📉', title: 'Equipe técnica consumida por operação', body: 'Sem visibilidade de funil, sem follow-up sistemático, sem processo claro de nutrição. A operação rola na intuição.' },
            ].map((item, i) => (
      ...
      <section className="section-padded" style={{ background: C.bg }}>
        <div className="container">
          <div className="section-header">
            <SectionTag>O que a YumIA instala no escritório</SectionTag>
            <h2 className="section-h2" style={{ color: C.white }}>
              IA que qualifica, agenda e converte<br />enquanto você foca no direito.
            </h2>
          </div>
            ...
            {[
              {
                ...
                body: 'IA responde no WhatsApp instantaneamente, qualifica o tipo de demanda, tria por urgência e agenda consultas automaticamente.',
                tags: ['Resposta < 60 seg', 'Triagem automática', 'Agendamento inteligente'],
              },
              {
                nome: 'Reativação de Base',
                resultado: 'Receita adormecida convertida em caixa',
                body: 'Campanhas automáticas para base inativa. Segmentação por área de atuação e período de inatividade. Taxa de reativação média de 2,5%.',
                tags: ['Segmentação inteligente', 'Mensagens personalizadas', 'Novos casos e indicações'],
              },
              {
                nome: 'Inteligência Operacional',
                resultado: 'Decisões baseadas em dados, não em achismo',
                body: 'Dashboard de funil em tempo real. Quais áreas geram mais leads, onde os clientes travam, previsão de receita por área de atuação.',
                tags: ['Funil em tempo real', 'Performance por área', 'Previsão de receita'],
              },
            ].map((s, i) => (
      ...
      <section id="metodo" className="section-padded" style={{ background: '#09091a' }}>
        <div className="container">
          ...
          <div className="grid-4">
            {[
              { l: 'M', nome: 'Mapeamento', time: 'Semana 1', body: 'Diagnóstico do escritório: volume de contatos, taxa de conversão, base inativa, gargalos de atendimento.' },
              { l: 'A', nome: 'Arquitetura', time: 'Semana 2', body: 'Desenho personalizado de automações, integrações e fluxos para a realidade jurídica.' },
              { l: 'P', nome: 'Prototipagem', time: 'Semanas 3–5', body: 'Implementação progressiva. A equipe já sente a diferença — sem esperar um projeto pronto.' },
              { l: 'A', nome: 'Aceleração', time: 'Contínuo', body: 'Monitoramento de ROI, ajuste de modelos e expansão. A IA melhora com o tempo.' },
            ].map((m, i) => (
        ...
        <div className="container cta-container">
          ...
          <div className="cta-header">
            <h2 className="cta-h2" style={{ color: C.white }}>
              ...
              <span style={{ color: C.gold }}>adormecido no seu escritório.</span>
            </h2>
          ...
          <div className="what-you-get" style={{ background: C.panel, border: `1px solid ${C.border}` }}>
            ...
            <GreenCheck>Análise do volume de contatos e taxa de conversão</GreenCheck>
      ...
      <a href="https://wa.me/5511964180674?text=Ol%C3%A1!%20Sou%20de%20um%20escrit%C3%B3rio%20de%20advocacia%20e%20quero%20entender%20onde%20estou%20perdendo%20receita."
